	...
	<!--______________________search bar_______________________-->
		...
		<div class="srch">
			<form class="navbar-form" method="post" name="form1">
					...
					<input class="form-control" type="text" name="search" placeholder="搜索书籍...">
		...
		<!--__________________________repuest book__________________-->
		<div class="srch">
			<form class="navbar-form" method="post" name="form1">
				
					<input class="form-control" type="text" name="bid" placeholder="输入书籍编号" required="">
					<button style="background-color: #5fc4ce;" type="submit" name="submit1" class="btn btn-default">借阅
					</button>
